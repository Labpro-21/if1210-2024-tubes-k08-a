...
from .driver_std import _DriverStd, _driverstd_new, _driverstd_tick, _driverstd_draw, _driverstd_move_line, _driverstd_set_current_attribute, __get_terminal_size
...
__get_terminal_size = __get_terminal_size
